    ...
    if(opcion1):
        if (opcion1 == 1 or opcion1 == 2 or opcion1 == 3 or opcion1 == 4 or opcion1 == 5
            or opcion1 == 6):
                ...
                print(x23)
                print('')
                opcion1 = obtener_int('[?] Ingrese la opción: ', minValor=1, maxValor=4)
                if(opcion1):
...
def validar_aumentar_slice() -> int:
    ...
    print(x33)
    print('')
    opcion22 = obtener_int(' Ingrese la opción: ', minValor=1, maxValor=7)
    print('')
    x93 = PrettyTable()
...
def validar_conectividad() -> int:
    ...
    if (opcion1):
        if (opcion1 == 1):
            ...
            print(x44)
            print('')
            opcion2 = obtener_int(' Ingrese la opción: ', minValor=1, maxValor=7)
            ...
            print(x55)
            print('')
            opcion12 = obtener_int('[?] Ingrese la opción: ', minValor=1, maxValor=6)
            opcion13 = obtener_int('[?] Ingrese la opción: ', minValor=1, maxValor=6)
